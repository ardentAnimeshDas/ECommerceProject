        ...
        <>
            <div class="row container-fluid">
                <div class="col-sm-6 col-md-3">
                    <div class="Card">
                        <div class="card-body">
                        <img src='/Images/home_product/iphone/product-item1.jpg' alt='img'/>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="Card">
                        <div class="card-body">
                        <img src='/Images/home_product/iphone/product-item2.jpg' alt='img'/>
                        <h2 className='item-name'>Iphone 11</h2>
                        <span className='item-description'>M.R.P.: ₹44,999.00</span>
                        <div class="hide">
                            <button class="kart"><FontAwesomeIcon icon={faShoppingCart}/>Add to Cart</button>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="Card">
                        <div class="card-body">
                        <img src='/Images/home_product/iphone/product-item3.jpg' alt='img'/>
                        <h2 className='item-name'>Iphone 11</h2>
                        <span className='item-description'>M.R.P.: ₹44,999.00</span>
                        <div class="hide">
                            <button class="kart"><FontAwesomeIcon icon={faShoppingCart}/>Add to Cart</button>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="Card">
                        <div class="card-body">
                        <img src='/Images/home_product/iphone/product-item4.jpg' alt='img'/>
                        <h2 className='item-name'>Iphone 11</h2>
                        <span className='item-description'>M.R.P.: ₹44,999.00</span>
                        <div class="hide">
                            <button class="kart"><FontAwesomeIcon icon={faShoppingCart}/>Add to Cart</button>
